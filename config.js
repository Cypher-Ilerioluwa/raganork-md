...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~bf892840849dbf47607efa6f175703af:2b6c564f59483777716c673d',
    ...
    BOT_NAME: process.env.BOT_NAME || 'ÀKÀNDÉ-BOT🤖🌹🍀',
